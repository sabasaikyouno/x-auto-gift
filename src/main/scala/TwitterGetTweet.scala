  ...
  def tweetList(url: String)(implicit chrome: ChromeDriver) = {
    ...
    Try {
      ...
      chrome
        ...
        .findElements(By.cssSelector(".css-4rbku5.css-18t94o4.css-901oao.r-1bwzh9t.r-1loqt21.r-xoduu5.r-1q142lx.r-1w6e6rj.r-1tl8opc.r-a023e6.r-16dba41.r-9aw3ui.r-rjixqe.r-bcqeeo.r-3s2u2q.r-qvutc0"))
        .asScala
